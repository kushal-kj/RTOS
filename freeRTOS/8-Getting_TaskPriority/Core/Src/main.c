...
void vRedLEDControllerTask(void *pvParameters)		//Task1 Function
{
	while(1)
	{
		...
		//Changing the Tasks own Priority from 2 to 1
		vTaskPrioritySet(NULL,1);			//NULL or red_Handle
	}
...
void vGreenLEDControllerTask(void *pvParameters)		//Task2 Function
{
	...
	{
		GreenTaskProfiler++;
		yellow_priority=uxTaskPriorityGet(yellow_Handle);
	}
