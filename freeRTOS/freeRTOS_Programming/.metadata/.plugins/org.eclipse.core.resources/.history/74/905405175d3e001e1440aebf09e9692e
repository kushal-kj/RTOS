...
void digital_sensor_task(void *pvParameters)
{
	...
	while(1)
	{
		...
		/*Difference between binary semaphore and a mutex  is, at the beginning of mutex we don't need to give the semaphore,
		 *we just check if the semaphore is available or not.
		 *Whereas in binary semaphore, someone has to give the semaphore at the beginning or else it will end up in DEADLOCK.
		 */
