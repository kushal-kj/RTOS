...
SemaphoreHandle_t xBinarySemaphore;		//Semaphore handle
...
void redLedControllerTask(void *pvParameters)
{
	xSemaphoreGive(xBinarySemaphore);		//First give the semaphore to avoid a deadlock
	while(1)
	{
		xSemaphoreTake(xBinarySemaphore,portMAX_DELAY);		//Take the semaphore
