...
void vRedLEDControllerTask(void *pvParameters);			//Task1 declaration
void vGreenLEDControllerTask(void *pvParameters);		//Task2 declaration
void vYellowLEDControllerTask(void *pvParameters);		//Task3 declaration

typedef uint32_t TaskProfiler;

TaskProfiler RedTaskProfiler,GreenTaskProfiler,YellowTaskProfiler,IdleTaskProfiler;
...
/* Note : You need to enable configUSE_IDLE_HOOK to 1 in FreeeRTOSConfig.h
 * for enabling HOOK function of IDLE task
 * */

void vApplicationIdleHook(void)			//Idle task's HOOK function
{
	//Do something
	IdleTaskProfiler++;
}
