...
void SenderTask1(void *pvParameters);		//Data sending Task1
void SenderTask2(void *pvParameters);		//Data sending Task2

void ReceiverTask(void *pvParameters);		//Data receiving Task
...
int main(void)
{
  ...
  //Create 2 sender tasks of same priority which is lower than the receiver task priority

  xTaskCreate(SenderTask1,				//Task1 creation
		  "Sender Task 1",
		  100,
		  NULL,
		  1,
  ...
  xTaskCreate(SenderTask2,				//Task2 creation
		  "Sender Task 2",
		  100,
		  NULL,
		  1,
  ...
  xTaskCreate(ReceiverTask,				//Task3 creation
		  "Receiver Task",
		  100,
		  NULL,
		  2,
